...
public class Media extends PlayObject<Media.Event> {
    ...
    public Track getTrackByType(int type) {
        final Track[] tracks = getTracks();
    ...
    public VideoTrack getVideoTrack() {
        return (VideoTrack) getTrackByType(1);
    }
    ...
    public int getVideoBitrate() {
        return getVideoTrack().bitrate;
    }

    public String getVideoCode() {
        return getVideoTrack().codec;
    }
...
//        addOption(":file-caching=600");
        addOption(":network-caching=300");//FIXME latency Time this is buffer ?!!!
